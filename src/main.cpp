...
int main(int argc, const char * argv[]) {
  ...
  path_option.description = "Path of the initial schedule file";
  ...
  init_command.description = "Create an initial schedule file";
  init_command.callback = Cli::init;

  Command write_command;
  write_command.name = "write";
  write_command.description = "Write cron jobs that defined in initial schedule file to crontab";
  write_command.callback = Cli::write;

  Command clear_command;
  clear_command.name = "clear";
  clear_command.description = "Clear cron jobs that defined in initial schedule file from crontab";
